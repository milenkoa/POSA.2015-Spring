...
public class AcronymOps
    ...
    public void onConfiguration(Activity activity,
        ...
        if (firstTimeIn) {
            ...
            RestAdapter adapter = new RestAdapter.Builder().setEndpoint(AcronymWebServiceProxy.ENDPOINT).build();
            mAcronymWebServiceProxy = adapter.create(AcronymWebServiceProxy.class);
        } else
    ...
    public List<AcronymExpansion> doInBackground(String acronym) {
        try {
            ...
            // service.
                ...
                AcronymData result = results.get(0);
