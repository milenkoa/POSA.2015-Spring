...
public interface VideoServiceProxy {
    ...
    /**
     * The path to rate a video
     */
    public static final String VIDEO_RATE_PATH =
            VIDEO_SVC_PATH
                    + "/{"
                    + VideoServiceProxy.ID_PARAMETER
                    + "}/rate";
     ...
     *
     */
    @POST(VIDEO_RATE_PATH)
    public Video rateVideo(@Path(ID_PARAMETER) long id, @Query("rating") int rating);
